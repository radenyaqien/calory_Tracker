    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.event(NutrientGoalEvent.OnCarbRatioEnter(it))
                },
                unit = stringResource(
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.event(NutrientGoalEvent.OnProteinRatioEnter(it))
                },
                unit = stringResource(
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.event(NutrientGoalEvent.OnFatRatioEnter(it))
                },
                unit = stringResource(
        ...
        ActionButton(
            ...
            onclick = {
                viewModel.event(NutrientGoalEvent.OnNextClick)
            },
